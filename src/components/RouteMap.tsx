                ...
                <Navbar />
                    ...
                    <div className = "mt-[15px] mx-[10px] font-open-sans">
                        <ul className = "mt-[15px] ml-[20px]">
                            ...
                            {/* Teks 'Senin - Jumat : 06.00 - 18.00 WIB' */}
                            ...
                            {/* Teks 'Sabtu - Minggu : TIDAK Beroperasi' */}
